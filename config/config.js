...
module.exports = {
  ...
  print: {
	...
	"taarnby_vand": { // Your print templates. "print" is the default
		A4: {
			l: {
				mapsizePx: [1060, 730],
				mapsizeMm: [280, 192]
	...
	"taarnby_afloeb": { // Your print templates. "print" is the default
		A4: {
			l: {
				mapsizePx: [1060, 730],
				mapsizeMm: [280, 192]
	...
	"viborg_kommune": { // Your print templates. "print" is the default
		A4: {
			l: {
				mapsizePx: [1060, 730],
				mapsizeMm: [280, 192]
	...
	"odense_kom": { // Your print templates. "print" is the default
		A4: {
			l: {
				mapsizePx: [1060, 730],
				mapsizeMm: [280, 192]
  ...
  baseLayers: [
    ...
    {
      type: "MVT",
      url: "mvt/official/3857_skaermkort_graa.json",
    ...
    {
      type: "MVT",
      url: "mvt/official/3857_skaermkort_daempet.json",
      id: "mvt_skaermkort_daempet",
      name: "Skærmkort dæmpet (vector)",
      description: ".",
      attribution: ".",
      minZoom: 8,
      maxZoom: 20,
    ...
    {
      type: "MVT",
      url: "mvt/official/3857_skaermkort_klassisk.json",
    ...
    {
      type: "MVT",
      url: "mvt/official/3857_skaermkort_moerkt.json",
      id: "mvt_skaermkort_moerkt",
      name: "Skærmkort mørk (vector)",
      description: ".",
      attribution: ".",
      minZoom: 8,
      maxZoom: 20,
